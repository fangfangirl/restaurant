...
<html>
	...
	<body>
		...
		<div class="navbar-fixed">
			<nav>
				<div class="nav-wrapper deep-orange lighten-3">
					...
					<a class="brand-logo center"><i class="material-icons">filter_tilt_shift</i>會員密碼更改</a>
					...
					<div class="col s12 brown lighten-4">
						...
						<div class="col s12 brown lighten-5">
							...
							<div class="col offset-s8">
								<a class="btn deep-orange lighten-3 " href="update_CusAccount.php">回資料修改頁面</a>
							</div>
							<div class="row">
								<div class="col s8 offset-s2">
									...
									<h5>會員密碼更改</h5>
									<div>
										<form name='changepassword_c' method="post" onsubmit="return enter123()" action="../model/update_CusPassword_check.php">
											<div class="col s12">
												<h1> </h1>
											</div>
		...
		<script type="text/javascript"> 
			function enter123() 
			{ 
				var y1=document.forms["changepassword_c"]["Oldpassword"].value; 
				var y2=document.forms["changepassword_c"]["Newpassword"].value; 
				var y3=document.forms["changepassword_c"]["Againnewpassword"].value;
